...
class Expressions_Analytics {
	...
	private function define_admin_hooks()
	{
		...
		$this->loader->add_filter( 'contextual_help', $plugin_dashboard, 'expana_dashboard_help', 10, 3 );
		...
		$this->loader->add_action( 'wp_ajax_expana_ajax_get_date', $plugin_dashboard, 'expana_ajax_get_date' );
		...
		$this->loader->add_action( 'wp_ajax_expana_ajax_seo_rankings', $plugin_dashboard, 'expana_ajax_seo_rankings' );
